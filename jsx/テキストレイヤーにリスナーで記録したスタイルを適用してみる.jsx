...
newLay.textItem.font = "M+ 2c-regular"; // フォント名 Postscript名でないとだめ？
// newLay.name = writeText; //レイヤー名
newLay.textItem.contents = "TEST"; // テキストレイヤーに文字列を設定
  //カラーに描画色をセット
var textColor = new SolidColor;
  // textColor.rgb.red = 200;
  // textColor.rgb.green = 200;
  // textColor.rgb.blue = 200;
textColor.rgb.hexValue = 'FFFFFF';  //Hexで指定することもできる
