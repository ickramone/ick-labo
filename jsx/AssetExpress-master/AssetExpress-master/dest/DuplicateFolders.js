...
var DuplicateFoldersDialog, dfd,
  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;

DuplicateFoldersDialog = (function(superClass) {
  extend(DuplicateFoldersDialog, superClass);

  DuplicateFoldersDialog.prototype.label = {
    windowName: 'フォルダー複製',
    arr: "配列",
    prefix: "接頭辞",
    suffix: "接尾辞",
  ...
  function DuplicateFoldersDialog(windowName) {
    this.onClickedOK = bind(this.onClickedOK, this);
    DuplicateFoldersDialog.__super__.constructor.call(this, this.label.windowName);
  ...
  DuplicateFoldersDialog.prototype.onClickedOK = function() {
    var activeLayer, arr, asc, i, ind, index, j, k, key, layer, layerSets, len, len1, parent, prefix, suffix;
    ...
    if (arr) {
      ...
      asc = this.uDlg[this.label.sort.group]["ASC"].value;
      ...
      if (arr.length > 0) {
        for (ind = k = 0, len1 = parent.length; k < len1; ind = ++k) {
          layer = parent[ind];
          i = asc ? ind : parent.length - ind - 1;
